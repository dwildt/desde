...
Contexto do projeto **Desde** para o Gemini CLI.
...
- **CSS Variables obrigatórias**: nunca usar valores literais de cor ou espaçamento — usar tokens de `styles/variables.css`
